...
另外，标记“可选”的域只是在技术层面上可选的，
因为通常来说，仅有“必选”域对于文献格式规则往往是不够的。
...
技术或其它文档，不必是出版的形式。
按照 \secref{bib:use:key} 节，\bibfield{author} 或者 \bibfield{editor} 是可以省略的。
...
例如，当 |author-year|（|作者-年份|）引用样式要生成条目的引用，但作者或年份缺失，
