...
详见 Perl 模块 \texttt{Text::BibTeX} 的手册页 \fnurl{http://search.cpan.org/~ambs/Text-BibTeX}。
...
上述两个选项详见\secref{use:opt:pre:gen} 节。\footnote{当使用biblatex时，不设置\texttt{refsection} 和 \texttt{refsegment}选项，那么 titlesec 就没有兼容性问题，完全可以使用——译注}
